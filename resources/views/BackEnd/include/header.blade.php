@php
  $siteInfo = DB::table('site_infos')->where('id', 1)->first();
@endphp
          ...
          @if (!empty($siteInfo->logo))
            ...
            <li class="nav-item theme-logo">
                <a href="{{ route('admin_dashboard') }}">
                    <img src="{{ asset("Back/images/logo/".$siteInfo->logo) }}" class="navbar-logo" alt="logo">
                </a>
            </li>
            <li class="nav-item theme-text">
                <a href="{{ route('admin_dashboard') }}" class="nav-link"> {{ $siteInfo->title }} </a>
            </li>
          @endif
        </ul>
        ...
        <ul class="navbar-item flex-row ml-md-auto">
            ...
            <li class="nav-item dropdown user-profile-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                   ...
                   </span> <img src="{{ asset("Back/images/logo/".$siteInfo->logo) }}" alt="avatar">
                   @endif
                </a>
